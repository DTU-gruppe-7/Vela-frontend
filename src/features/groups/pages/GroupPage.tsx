        ...
        <div className="max-w-6xl mx-auto py-10 px-4">
            <div className="flex justify-end mb-10">
                <button 
                    ...
                    className="flex items-center justify-center gap-2 bg-orange-600 text-white px-5 py-2.5 rounded-xl font-semibold hover:bg-orange-700 transition shadow-md"
                >
                    <FiPlus /> Opret ny
                </button>
            </div>
