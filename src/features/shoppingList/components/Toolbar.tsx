...
function Toolbar({ hasCheckedItems, hasItems, disableBulkActions, onDeleteChecked, onClearAll }: ToolbarProps) {
  return (
    <div className="mb-4 flex items-center justify-end px-1">
      <div className="flex items-center gap-2">
        <button
          onClick={onDeleteChecked}
          disabled={!hasCheckedItems || disableBulkActions}
        ...
        <button
          onClick={onClearAll}
          disabled={!hasItems || disableBulkActions}
